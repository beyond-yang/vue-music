...
// 提交搜索历史并将搜索历史保存到本地
export const saveSearch = function ({
    commit
}, query) {
...
//删除搜索历史中的某条数据
export const deleteHistoryOne = function ({
    commit
}, deleteItem) {
...
// 清空所有的歌曲搜索历史
export const deleteHistoryAll = function ({
    commit
}) {
...
// 清除播放列表中的所有数据
export const clearListAll = function ({
    commit
}) {
...
// 收藏歌曲
export const saveFavorite = function ({
    commit
}, song) {
...
// 取消歌曲收藏
export const cancelFavorite = function ({
    commit
}, song) {
    commit(types.SET_FAVORITE_LIST, cancelFavoriteSong(song))
}